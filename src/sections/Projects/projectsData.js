...
const projectsData = [
    {
        name: "Pokedex",
        description: "En este proyecto he creado una pokedex consumiendo la PokeApi para obtener la base de datos de mas de 1000 pokemones. La pokedex cuenta con un sistema de paginado y por  cada pagina traera cierta cantidad de pokemones, tambien he implementado el uso de un estado global para  agregar una funcionalidad en donde el usuario puede seleccionar sus pokemones favoritos, tambien cuenta con un sistema de filtrado en reactivo en donde puedes buscar el pokemon  que haga match con la keyword de la busqueda ",
